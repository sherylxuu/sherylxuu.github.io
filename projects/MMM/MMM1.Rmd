...
ggplot(selected_vec_long, aes(x = ds, y = contribution, fill = channel)) +
  ...
  labs(
    title = "Time-Series Channel Contributions (Blue Palette)",
...
**Recommended Actions:**
These changes aim to optimize budget allocation, increase marketing efficiency, and ultimately drive higher incremental sales without increasing total spend.
